...
namespace MediatR.Unity
{
    ...
    /// <summary>
    /// copied from https://github.com/jbogard/MediatR/blob/50af3de7fa89d56067952581179fa22a1b66de0b/samples/MediatR.Examples.Unity/Program.cs#L50
    /// </summary>
            ...
            return container.RegisterType<IMediator, Mediator>(lifetimeManager)
                .RegisterInstance<ServiceFactory>(type =>
                {
                    ...
                    if (enumerableType != null)
                        return container.ResolveAll(enumerableType.GetGenericArguments()[0]);

                    if (container.IsRegistered(type))
                        return container.Resolve(type);

                    throw new NotSupportedException($"unable to regsiter {type} for dependency injection");

                });
        }

        public static IUnityContainer RegisterMediatorHandlers(this IUnityContainer container, params Assembly[] assemblies)
        {
